...
*/
public class Circle {  //inheritance parent class and is extended to child class cylinder

    double radius;              //variable
    public  Circle(double radius){         //constructor
        if(radius<0){
            this.radius=0;   //constructor decalred this.radius is variable of constructor
   ...
   double area=radius*radius*Math.PI;  //formula ro find radius
   return area;
