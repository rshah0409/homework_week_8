...
NOTE: In total, you have to write 7 methods.
  */
    ...
    //Method overloading in ths class.subtype of polymorphism.

    int x, y;

    public Point16() {                           //constructor with no args
        System.out.println( "" );
    }

    public Point16(int x, int y) {             //constructor with two args.
    ...
    public double distance(Point16 another) {
        double distance;
        return distance = Math.sqrt( (another.x * (another.x + (another.y * (another.y)))) );
