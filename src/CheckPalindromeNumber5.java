...
A palindrome number is a number which when reversed is equal  to the original number. For example: 121, 12321, and 1001 etc.
...
for example reverse = 0.  Extract the last digit of the given number by performing the modulo division (remainder).
...
*/
public class CheckPalindromeNumber5 {

    public static boolean isPalindrome(int number) {
        int lastDigit, reverse = 0, temp;
        int absNumber = Math.abs( number );                      //It is the number variable to be checked for palindrome
        boolean result;

        temp = absNumber;          //math absnumber variable.
        result = true;
        //if and while loop.
        while (temp > 0) {
        ...
        public static void main(String[] args) {
            ...
            System.out.println(isPalindrome( -1221 ));   //static method called into main method
